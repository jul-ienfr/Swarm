...
describe('dashboard smoke helper', () => {
  ...
  it('serves the dashboard page and proxies api calls from the standalone helper', async () => {
    ...
    try {
      ...
      expect(rootHtml).toContain('Maker inventory / quote state')
      expect(rootHtml).toContain('Strategy Desk')
      expect(rootHtml).toContain('Strategy Families')
      expect(rootHtml).toContain('Run sort')
      expect(rootHtml).toContain('Cross-Venue / Arbitrage')
      expect(rootHtml).toContain('Arbitrage quality ranking')
      expect(rootHtml).toContain('Trader desk alert')
      expect(rootHtml).toContain('Reset arbitrage')
      expect(rootHtml).toContain('Research pipeline trace')
      expect(rootHtml).toContain('Research validation')
      expect(rootHtml).toContain('Validation blockers')
      expect(rootHtml).toContain('Operator thesis')
      expect(rootHtml).toContain('Approval ticket')
      expect(rootHtml).toContain('Kelly / risk cap')
      expect(rootHtml).toContain('read-only context')
      expect(rootHtml).toContain('approval actors')
      expect(rootHtml).toContain('live route status')
