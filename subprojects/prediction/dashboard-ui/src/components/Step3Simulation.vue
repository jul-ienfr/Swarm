          ...
          >
            ...
            <div class="timeline-card">
              ...
              <div class="card-body">
                ...
                <!-- Generic fallback: unknown type or unprocessed content -->
...
// Track previous round per platform for change detection
...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Extra check: platforms may report completion before runner_status updates
...
const checkPlatformsCompleted = (data) => {
  ...
  // If at least one platform completed, check if all enabled ones completed
  // Determine if platform enabled via actions_count > 0 or was running
