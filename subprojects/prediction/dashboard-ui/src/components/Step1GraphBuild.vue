    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are automatically chunked and processed via Zep to build a knowledge graph, extracting entities and relationships, forming temporal memory and community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph building is complete. Please proceed to simulation environment setup.</p>
          <button 
            class="action-btn" 
