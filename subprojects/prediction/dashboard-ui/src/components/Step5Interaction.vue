          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick chat version of the report generation agent, with access to 4 professional tools and MiroFish's complete memory</div>
              </div>
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that conduct parallel multi-turn conversations with agents in the simulated world, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
...
const renderMarkdown = (content) => {
  ...
  // Clean <p><br> before block elements
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Clean consecutive <br> tags
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Clean <br> between block and paragraph starts
