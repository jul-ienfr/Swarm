    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a piece of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world composed of up to <span class="highlight-orange">millions of Agents</span> based on the real-world seeds within it. By injecting variables from a god's-eye view, it finds <span class="highlight-code">"local optimal solutions"</span> in dynamic environments through complex group interactions.
            </p>
            <p class="slogan-text">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & persona generation & environment configuration Agent injection of simulation parameters</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & automatic prediction demand parsing & dynamic temporal memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Chat with any individual in the simulated world & interact with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction request in natural language (e.g., What public opinion trends would emerge if University X issued an announcement reversing a disciplinary decision?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
